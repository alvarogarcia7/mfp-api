.PHONY: help install install-prod run run-prod test test-cov typecheck clean lint format dev-setup mfp-download mfp-parse polar-download polar-parse pre-commit-install
